...
export function ChordHint({ chordId, imageUrl, visible }: Props) {
  ...
  if (imgFailed) {
    return (
      <div className={`mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-center ${visibilityClass}`}>
  ...
  return (
    <div className={`mt-6 flex flex-col items-center gap-2 ${visibilityClass}`}>
      <img
        src={imageUrl}
